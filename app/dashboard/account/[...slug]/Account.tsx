                ...
                >
                  {secondaryNavigation.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className={item.current ? "text-primary-400" : ""}
                      >
                        {item.name}
                      </a>
                    </li>
                    ...
                    <div className="col-span-full">
                      ...
                      <div className="mt-2">
                        <select
                          id="timezone"
                          name="timezone"
                          className="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6 [&_*]:text-black"
                        >
...
export default function AccountPage({ data }: any) {
  ...
  return (
    <SideBarLayout
      ...
      currentEstablishment={currentEstablishment} //@ts-ignore
      loading={loading}
    >
      <>
