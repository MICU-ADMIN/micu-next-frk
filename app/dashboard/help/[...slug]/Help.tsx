      ...
      <header className="bg-gray-50 p-8 rounded-full">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-8">
              {/* <p className='mt-2 flex items-center text-sm text-gray-500'>
								...
								/>
								A schedule of
								<b className=' text-primary-600 font-bold px-1'>
									obligatory
								</b>
								prayers
								conducted at the
          ...
          {/* <div className='mt-5 flex xl:ml-4 xl:mt-0'>
						...
						<div className=' ml-3 inline-flex divide-x divide-primary-600 rounded-md shadow-sm'>
							<div className='inline-flex divide-x divide-primary-600 rounded-md shadow-sm'>
								<button
									...
									className='inline-flex items-center gap-x-1.5 rounded-md bg-primary-500 px-3 py-2 hover:bg-primary-600 text-white shadow-sm'
								>
									<PlusIcon
...
// 			<header className='bg-primary-500 p-4 text-white'>
...
// 						className='bg-primary-500 text-white py-2 px-4 rounded hover:bg-primary-600 transition duration-300'
// 					>
// 						Join Discord
// 					</a>
// 				</section>
