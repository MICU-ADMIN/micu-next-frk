      ...
      <div className="isolate flex flex-auto overflow-hidden bg-white">
        <div ref={container} className="flex flex-auto flex-col overflow-auto">
          ...
          >
            ...
            >
              <span>T</span>
              <span className="mt-3 flex h-8 w-8 items-center justify-center rounded-full text-base font-semibold text-primary-600">
                20
              </span>
            </button>
            <button
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                ...
                >
                  <a
                    href="#"
                    className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-primary-50 p-2 text-xs leading-5 hover:bg-primary-100"
                  >
                    <p className="order-1 font-semibold text-primary-700">
                      Breakfast
                    </p>
                    <p className="text-primary-500 group-hover:text-primary-700">
                ...
                >
                  ...
                  >
                    ...
                    <p className="order-1 text-primary-500 group-hover:text-primary-700">
                      Eiffel Tower
                    </p>
                    <p className="text-primary-500 group-hover:text-primary-700">
