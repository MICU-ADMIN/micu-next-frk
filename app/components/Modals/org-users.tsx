...
function OrgUserModal({ open, setOpen, setColleague }) {
  ...
  useEffect(() => {
    fetch("/api/org-colleagues")
      .then((res) => res.json())
      .then((orgColleaguesData) => {
        dispatch({
          type: "SET_ORG_COLLEAGUES",
          payload: orgColleaguesData,
        });
      });
    fetch("/api/org-colleagues/recent")
      .then((res) => res.json())
      .then((recentOrgColleaguesData) => {
        dispatch({
          type: "SET_RECENT_ORG_COLLEAGUES",
          payload: recentOrgColleaguesData,
        });
      });
  ...
  if (!state.data) return <p>No profile data</p>;
