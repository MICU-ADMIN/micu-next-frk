        ...
        <div className="flex flex-row items-center">
          {view !== "table" && (
            <TableIcon
              ...
              className="cursor-pointer ml-4 w-6 h-6 text-gray-500 hover:text-primary-500 transition duration-100 ease-in-out"
            />
          )}
          {view !== "calender" && (
            <Calendar
      ...
      <div>
        {loading && (
          <div className="text-sm fadeIn text-gray-500 flex items-center flex-row">
            <span className="mr-1 text-primary-500">Saving</span>{" "}
