...
function FileSidebar({
  ...
  const onDelFile = async () => {
    try {
      const res = await deleteFile(currentFile.key);
      if (!res?.errors) {
        if (currentFile.type.startsWith("image")) {
          setUploads((prev: { images: any[] }) => ({
            ...prev,
            images: prev.images.filter(
              (file: { key: any }) => file.key != currentFile.key
            ),
          }));
        } else if (currentFile.type.startsWith("video")) {
          setUploads((prev: { videos: any[] }) => ({
            ...prev,
  ...
  return (
    ...
    >
      <div className="w-fit space-y-6 pb-16 overflow-y-auto border-l border-gray-200 bg-white p-8 lg:block slideleft transition-all duration-300 ease-in-out transform translate-x-0 lg:translate-x-0 lg:static lg:inset-auto lg:translate-x-0 lg:shadow-none">
        {hash != `#Create` && (
          <>
            <p
              ...
              <div className="mb-4 flex justify-between ">
                ...
                <div className=" flex flex-row">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={onDelFile}
                    className="  text-red-500 bg-white border-red-500 border-2"
                  >
                    Delete
                  </Button>
                </div>
              ...
              {currentFile.cat === "image" ? (
                ...
                <div className="flex h-96 flex-col items-center justify-center">
                  <p className="text-lg font-medium text-gray-900">
                    {currentFile.name} is not supported
                  </p>

                  <Button
                    onClick={() =>
                      downloadFile(
                        publicUrl + currentFile.key,
                        currentFile.name
                      )
                    }
                    className="mt-2"
          ...
          {hash != "#Create" && currentFile ? (
            <>
              <div className=" flex items-start justify-between">
                ...
                <button
                  type="button"
                  className="ml-4 flex h-8 w-8 items-center justify-center rounded-full bg-white text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
              ...
              <div>
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-500">
                    Uploaded by: {currentFile.userId}
                  </p>

                  <p className="text-sm font-medium text-gray-500">
                    {currentFile.public ? "Public" : "Private"}
                  </p>
              ...
              <div>
                ...
                <div className="mt-2 flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
                  >
              ...
              <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                ...
                <div className="sm:col-span-3">
                  ...
                  <input
                    ...
                    className="mt-2 block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6"
                  />
                </div>
                ...
                <div className="sm:col-span-6">
                  ...
                  <p className="mt-3 text-sm text-slate-500">
                    Brief description for your upload.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-6">
                <div className="sm:col-span-6">
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    This information will be used to categorize and display your
                    media.
                  </p>
                </div>
