...
const UploadPageComponentView = dynamic(
  () => import("./UploadPageComponents"),
        ...
        <div className="hidden sm:block">
          <div className="flex items-center border-b border-gray-200">
            ...
            >
              {tabs.map((tab) => (
                <div
                  ...
                  aria-current={
                    props.currentTab === tab.name ? "page" : undefined
                  }
            ...
            <div className="ml-6 hidden items-center rounded-lg bg-gray-100 p-0.5 sm:flex">
              ...
              <span
                className="ml-0.5 cursor-pointer rounded-md p-1.5 hover:bg-white hover:shadow-sm "
