  ...
  return (
    <div className="mt-2  overflow-y-scroll max-h-[200px] text-sm text-gray-800">
      {scholarData?.fullName && (
        <p>
          {" "}
          <span className="text-primary-500">Full name:</span>{" "}
          {scholarData.fullName}{" "}
        </p>
      )}
      {scholarData?.areaOfInterest && (
        <p>
          <span className="text-primary-500">Area of interest:</span>{" "}
          {scholarData.areaOfInterest}{" "}
        </p>
      )}
      ...
      {scholarData?.teachers && (
        <p>
          <span className="text-primary-500">Teachers/narrated:</span>{" "}
          {scholarData.teachers}{" "}
        </p>
      )}
      ...
      {scholarData?.students && (
        <p>
          <span className="text-primary-500">Students/narrated to:</span>{" "}
          {scholarData.students}{" "}
        </p>
      )}
      ...
      {scholarData?.siblings && (
        <p>
          {" "}
          <span className="text-primary-500">Siblings:</span>{" "}
          {scholarData.siblings}{" "}
        </p>
      )}
      {
        scholarData?.spouses && (
          <p>
            {" "}
            <span className="text-primary-500">Spouses:</span>{" "}
            {scholarData.spouses}{" "}
          </p>
        ) /* spouse */
      }
...

      {
        scholarData?.tags && (
          <p>
            {" "}
            <span className="text-primary-500">Tags:</span> {scholarData.tags}{" "}
          </p>
        ) /* tags */
      }
    </div>
