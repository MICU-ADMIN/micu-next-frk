    ...
    <>
      <HeaderDiv className="header w-full text-white transition">
        ...
        >
          ...
          <Select
            noClear
            className="relative left-[10px] w-[160px] "
            placeholder="Page"
          ...
          <div title="Page settings">
            <Settings
              className="ml-5 h-[20px] cursor-pointer rounded text-gray-600 transition hover:bg-primary-300 hover:text-primary-900 "
              onClick={() => setShowSettingsMenu(true)}
            />
          </div>
          <div title="Add Page">
            <PlusCircle
              className="ml-2 h-[20px] cursor-pointer rounded text-primary-700 transition hover:bg-primary-300 hover:text-primary-900 "
              onClick={() => {
                preview();
          ...
          <div className="flex">
            {!readOnly && (
              <div className="relative mr-10 mt-1 flex flex-1 fadeIn">
                ...
                <p
                  onClick={onUndo}
                  className="text-gray-500 ml-5 cursor-pointer hover:text-primary-500"
                >
                  {/* <UndoSvg /> */}
                  Undo
                </p>
            ...
            <div className={` right-[${!readOnly ? "250px" : "100px"}]`}>
              <Layout
                ...
                title="Page Layout"
                xlinkTitle="Layout"
                className="mr-5  mt-1 h-[25px] cursor-pointer rounded text-gray-500 transition hover:bg-primary-300 hover:text-primary-900 "
            ...
            {!readOnly && (
              <Btn
                className="ml-3 cursor-pointer bg-primary-100 text-primary-700 transition hover:bg-primary-300"
                onClick={() => {
                  preview();
                  setShowPageSidebar(false);
                }}
      ...
      {showSettingsMenu && (
        <SettingsMenu close={() => setShowSettingsMenu(false)} />
      )}
      {}
    </>
  );
