...
type Props = {
  setShowPageSidebar: (val: boolean) => void;
...
const PageSidebar = ({ setShowPageSidebar, onDataChange, siteData, currentPage }: Props) => {
                ...
                <div className="flex flex-row justify-between items-center mt-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onDataChange({
                        ...siteData,
                        siteColors: siteData.siteColors.map((color: string, index: number) => (index == editingColoorIndex ? e.target.value : color)),
                      })
                    }
                  />
                </div>
