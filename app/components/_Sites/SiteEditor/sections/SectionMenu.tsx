...
function SectionMenu({ close, addSection, siteData }) {
  ...
  const [curSectionData, setCurSectionData] = React.useState(
                      ...
                      <div
                        ...
                        className={`semi-bold flex cursor-pointer flex-row items-center rounded-md p-1 hover:bg-gray-100 hover:shadow-md ${
                          selectedSection === section
                            ? "border-2 border-primary-500 bg-gray-100 shadow-md"
                            : ""
                        }`}
                      >
              ...
              {curSectionData.map((section, i) => {
                return (
                  <div
                    ...
                    className=" w-[75vw] cursor-pointer rounded shadow-md hover:border-2 hover:border-primary-500 hover:shadow-lg"
                  >
                    <Area
                      readOnly={true}
                      index={i}
