...
import DynamicText from "../Elements/DynamicText/DynamicText";
              ...
              <div className="px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                <div>
                  <div className="hidden sm:mb-4 sm:flex sm:justify-center lg:justify-start">
                    ...
                    >
                      <span className="rounded-full bg-primary-500 px-3 py-0.5 text-sm font-semibold leading-5 text-white">
                        We're hiring
                      </span>
