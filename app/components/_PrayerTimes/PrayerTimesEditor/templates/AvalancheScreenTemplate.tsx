  ...
  return (
    <nav className="flex" aria-label="Breadcrumb">
      <ol className="flex space-x-4 divide-y divide-gray-700 rounded-md bg-[#1D2431] px-6  shadow-inner">
        ...
        >
          <a className="text-center text-xl font-medium text-gray-400 hover:text-gray-700">
            Majid Quba
          </a>
          <a className="text-center text-3xl font-medium text-gray-100 hover:text-gray-700">
            12:11
          </a>
        </div>
      </ol>
        ...
        <div className="mx-auto max-w-full   lg:flex lg:pb-40">
          <div className="align-center mx-auto max-w-full flex-shrink-0 justify-center lg:mx-0 lg:max-w-xl ">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Silence Your Phone, Find Serenity: Please switch off your phone
              and maintain silence in the mosque. Let's create a peaceful and
              respectful environment for all worshippers. Thank you.
            </p>
          </div>
...
//           <PencilSquareIcon
//             className="absolute right-[6px] ml-2 mr-2 h-5 w-5 cursor-pointer text-primary-500 hover:text-gray-700"
//             aria-hidden="true"
//             title='Edit "Top Message"'
