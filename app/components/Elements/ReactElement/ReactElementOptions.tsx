...
function ReactEditOptions({ element, onChange, setShowEditMenu, targetRef, setTransform, onChangeData, colors }: Props) {
    ...
    return (
      <div>
        ...
        <button onClick={handleIncrement}>Increment</button>
                          ...
                          onChange={(evn) => {
                            if (evn.target.value.length > 3000) return alert("Max length is 3000 characters");
                            onChange({ ...element.data, componentString: evn.target.value });
                          }}
                          padding={15}
                          style={{
...
export default ReactEditOptions;
