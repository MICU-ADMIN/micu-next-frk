...
const EmbedInput = ({
  ...
  const embedSwitch = () => {
    switch (embedType) {
      ...
      case "website":
        return (
          <object height="100%" width="100%" data={selectedUrl} ref={ref} />
        );
      default:
        null;
    }
  ...
  return (
    <div className="mt-1 flex flex-col items-center">
      {showInput && !readOnly ? (
        ...
        isFocused && (
          <div className="z-99999 absolute top-[-2px] mb-4 flex w-full items-center justify-between">
            ...
            <PencilSquareIcon
              className="h-5 w-5 cursor-pointer text-gray-600 transition-all duration-200 hover:text-gray-900"
      ...
      <div
        className={`mb-5 mt-5 w-full overflow-auto rounded-md ${
          embedType !== "audio" && "border"
        } border-gray-200 `}
        style={{
