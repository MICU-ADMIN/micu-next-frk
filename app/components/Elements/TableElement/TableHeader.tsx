    ...
    <div className="flex flex-row justify-between items-center mb-1">
      ...
      {field?.addRow && (
        <button
          ...
          className="flex flex-row items-center px-2 py-1 rounded-md text-primary-500  hover:bg-primary-500 transition-all duration-200 hover:text-white hover:shadow-md"
        >
