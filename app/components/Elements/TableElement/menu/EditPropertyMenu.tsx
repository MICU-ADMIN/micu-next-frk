...
function EditPropertyMenu({
  ...
  return (
    <>
      ...
      >
        <p className="text-primary-500">Edit property</p>
        ...
        />
        <div
          className="mt-3 absolute bottom-3 left-3"
          style={{ opacity: changes ? 1 : 0.5 }}
        >
          <Button
            disabled={!changes}
            size="sm"
            onClick={() => onEditProperty(currentProperty)}
          >
            Save changes
          </Button>
        </div>
