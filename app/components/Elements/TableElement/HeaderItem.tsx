    ...
    <>
      <th
        ...
        onClick={(e) => {
          ...
          e.stopPropagation();
          setMenuOptions({
            columnEditIndex: index,
            columnTarget: e.currentTarget,
          });
        }}
        ...
        style={{
          width:
            isHorizontalScroll && column.editColumns
              ? "100px"
              : hardWith || width,
          paddingLeft: editColumns && index === 0 ? 30 : 8,
        }}
        className={`${
          hardWith ? "" : "border"
      ...
      >
        ...
        <span
          className="cursor-pointer hover:underline underline-2 underline-primary-500 hover:text-primary-500 w-full"
          // onClick={(e) => {
          //   e.stopPropagation();
        ...
        {column.editColumns && (
          <div className="flex flex-row">
            <PlusCircle
              className="text-primary-500 h-4 w-4 hover:text-primary-600 cursor-pointer"
              onClick={() =>
            ...
            />
            <MenuIcon
              className="text-gray-500 ml-2 h-4 w-4 hover:text-primary-600 cursor-pointer"
              onClick={() =>
                setMenuOptions((prev: any) => {
        ...
        {!hardWith && (
          <div
            ...
            className="absolute right-0 top-0 h-full w-[0.8px] hover:w-[1px] hover:bg-primary-500 bg-gray-100 cursor-col-resize hover:w-[3px]  "
          ></div>
        )}
      </th>
    </>
