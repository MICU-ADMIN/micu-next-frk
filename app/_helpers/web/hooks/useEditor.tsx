...
import { addToCache, getCacheData } from "../requestHandler";
// import { EmbedInputTool } from "@/app/components/_Articles/EditorTools/EmbedInputTool";
// import { HadithExplorerTool } from "@/app/components/_Articles/EditorTools/HadithExplorerTool";
// import { QuranExplorerTool } from "@/app/components/_Articles/EditorTools/QuranExplorerTool";
...
export const useEditor = () => {
  const init = async (
    ...
    console.log(data);
    try {
      const cachedEditorJs = await getCacheData("cachedEditorJs");
      ...
      let EmbedInputTool = cachedEditorJs?.EmbedInputTool;
      let HadithExplorerTool = cachedEditorJs?.HadithExplorerTool;
      let QuranExplorerTool = cachedEditorJs?.QuranExplorerTool;
      ...
      if (!Editorjs) {
        ...
        EmbedInputTool =
          await require("@/app/components/_Articles/EditorTools/EmbedInputTool")
            .EmbedInputTool;
        HadithExplorerTool =
          await require("@/app/components/_Articles/EditorTools/HadithExplorerTool")
            .HadithExplorerTool;
        QuranExplorerTool =
          await require("@/app/components/_Articles/EditorTools/QuranExplorerTool")
            .QuranExplorerTool;
      ...
      if (hasEditor && editor) {
        ...
        editor = await new Editorjs({
          ...
          tools: {
            ...
            hadithExplorer: HadithExplorerTool,
            linkTool: {
              class: linkTool,
              config: {
